...
- [x] 2. Implement pure logic modules for parallels
  ...
  - [x] 2.2 Write property test for parallel sort ordering
  ...
  - [x] 2.4 Write property test for parallel toggle state transition
  ...
  - [x] 2.6 Write property tests for parallel filters
  ...
  - [x] 2.8 Write property test for card-level status derivation
...
- [x] 4. Extend stats module for parallel statistics
  - [x] 4.1 Add parallel stats functions to `src/lib/stats.ts`
  ...
  - [x] 4.2 Write property tests for parallel statistics
...
- [x] 5. Update CSV import for parallel support
  - [x] 5.1 Update `src/lib/csv-import.ts` to support parallel column
  ...
  - [x] 5.2 Write property tests for CSV import with parallels
...
- [x] 6. Update offline cache for parallel data
  - [x] 6.1 Update `src/lib/offline-cache.ts` for version 2 schema
  ...
  - [x] 6.2 Write integration test for offline cache upgrade
...
- [x] 8. Implement hooks for parallel toggle and realtime
  - [x] 8.1 Create `src/hooks/useToggleParallel.ts`
  ...
  - [x] 8.2 Update `src/hooks/useRealtimeSubscription.ts` for parallel events
  ...
  - [x] 8.3 Write unit tests for useToggleParallel hook
    - Create `src/hooks/useToggleParallel.test.ts`
    - Test optimistic update, revert on failure, queue behavior for rapid toggles
    - _Requirements: 3.1, 3.5, 3.6_

- [x] 9. Implement ParallelPanel and ParallelItem components
  - [x] 9.1 Create `src/components/ParallelItem.tsx`
  ...
  - [x] 9.2 Create `src/components/ParallelPanel.tsx`
  ...
  - [x] 9.3 Write unit tests for ParallelPanel and ParallelItem
...
- [x] 10. Update CardRow components with expand/collapse and parallel count
  - [x] 10.1 Update `src/components/CardRow.tsx` (both Desktop and Mobile variants)
  ...
  - [x] 10.2 Update unit tests for CardRow
...
- [x] 11. Update FilterBar with parallel status filter
  - [x] 11.1 Update `src/components/FilterBar.tsx`
  ...
  - [x] 11.2 Write unit test for FilterBar parallel status dropdown
...
- [x] 12. Update StatsBar with parallel statistics
  - [x] 12.1 Update `src/components/StatsBar.tsx`
  ...
  - [x] 12.2 Write unit test for StatsBar parallel metrics
    - Update/create `src/components/StatsBar.test.tsx`
    - Test dual metric display, per-set breakdown with parallel counts
    - _Requirements: 5.1, 5.3_

- [x] 13. Wire everything together in AppShell
  - [x] 13.1 Integrate parallel data loading and state management in `src/components/AppShell.tsx`
  ...
  - [x] 13.2 Update `src/components/ImportModal.tsx` for parallel-aware import
